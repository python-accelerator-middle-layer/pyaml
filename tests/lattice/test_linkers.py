...
def test_various_naming_addressing():
    ...
    elts = sr.design.get_magnet("QF1E").strength._elements
    assert len(elts) == 31
    check_index(
        ring,
        elts,
    ...
    elts = sr.design.get_magnet("QF1E-ALL").strength._elements
    assert len(elts) == 32
    check_index(
        ring,
        elts,
    ...
    elts = sr.design.get_magnet("QF1E-C05").strength._elements
    assert len(elts) == 1
    check_index(ring, elts, [290])

    elts = sr.design.get_magnet("QF1E-C04-C05-C06").strength._elements
    assert len(elts) == 3
    check_index(ring, elts, [140, 290, 424])

    elts = sr.design.get_magnet("QF1E-C04-C05-C06-2").strength._elements
    assert len(elts) == 3
    check_index(ring, elts, [140, 290, 424])

    elts = sr.design.get_magnet("QF1E-C04-C05-C06-3").strength._elements
    assert len(elts) == 3
    check_index(ring, elts, [140, 290, 424])
